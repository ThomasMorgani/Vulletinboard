  ...
  >
    <v-card-title class="justify-start">
      <div>
        ...
        <p v-text="item.content_desc" class="text-left  description pr-4" :style="subtitleStyle"></p>
      </div>
    </v-card-title>
    <v-card-text v-text="timestampToHuman(item.content_date)" class="text-left" :style="footerStyle"></v-card-text>
  </v-card>
</template>
